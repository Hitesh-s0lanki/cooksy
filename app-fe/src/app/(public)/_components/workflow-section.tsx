...
const WorkflowSection = () => {
  ...
  return (
    <section
      id="workflow"
      className="w-full h-screen py-10 md:py-20 lg:py-20 space-y-10">
      <h1 className="text-center w-full text-xl md:text-3xl lg:text-4xl font-semibold">
        Our Agentic WorkFlow
      </h1>
      <div className="h-full w-full px-8 md:px-20 lg:px-40">
        <ReactFlow
          nodes={nodes}
          edges={edges}
